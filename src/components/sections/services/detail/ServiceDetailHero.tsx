      ...
      <div className={`${SERVICES_HERO_CONTENT} ${SERVICES_INNER}`}>
        <div ref={contentRef} className="max-w-3xl text-left">
          <nav aria-label="Breadcrumb" data-hero-reveal className={SERVICES_HERO_BREADCRUMB}>
            <ol className={`${SERVICES_HERO_BREADCRUMB_LIST} flex-wrap`}>
              <li>
                <Link href="/" className={`hover:text-white ${SERVICES_FOCUS_RING_LIGHT} rounded`}>
                  Home
                </Link>
              </li>
              ...
              <li>
                <Link href="/services" className={`hover:text-white ${SERVICES_FOCUS_RING_LIGHT} rounded`}>
                  Services
                </Link>
              </li>
              <li aria-hidden className="text-white/40">
