...
export default function CaseStudyCTA() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="Case study call to action"
      ...
      <div className={PROJECTS_INNER}>
        <div className="group relative overflow-hidden rounded-[32px] border border-[#e8edf2] shadow-[0_20px_56px_rgba(15,23,42,0.14)] dark:border-border">
          ...
          >
            ...
            <h2
              data-cta-reveal
              className="mx-auto max-w-[800px] text-[32px] font-bold leading-[1.12] tracking-tight text-white sm:text-[40px] lg:text-[48px]"
            >
              Let&apos;s Build the Next Landmark Together
            </h2>
            <p
              data-cta-reveal
              className="mx-auto mt-5 max-w-2xl text-base leading-[1.85] text-white/75 sm:text-lg"
            >
              Ready to discuss your engineering requirements? Partner with HS Group for disciplined delivery across power, telecom, renewable, and infrastructure programs.
            </p>
            <div
              data-cta-reveal
