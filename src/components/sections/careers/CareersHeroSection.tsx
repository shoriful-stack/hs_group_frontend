...
import { careersHero } from "@/data/careers-page";
...
export default function CareersHeroSection() {
  ...
  return (
    <section ref={sectionRef} className={CAREERS_HERO_SHELL} aria-label="Careers">
      <div ref={imageRef} className="absolute inset-0">
        <Image src={careersHero.image} alt="" fill priority className={CINEMATIC_IMAGE} sizes="100vw" />
      </div>
        ...
        <div ref={contentRef} className="max-w-3xl text-left">
          <nav aria-label="Breadcrumb" data-hero-reveal className={CAREERS_HERO_BREADCRUMB}>
            <ol className={CAREERS_HERO_BREADCRUMB_LIST}>
              <li>
                <Link href="/" className={`hover:text-white/90 ${CAREERS_FOCUS_RING_LIGHT} rounded`}>
                  Home
                </Link>
              </li>
          ...
          <div data-hero-reveal className="flex w-full flex-col gap-3 sm:flex-row sm:gap-4">
            ...
            <Link
              href={careersHero.secondaryCta.href}
